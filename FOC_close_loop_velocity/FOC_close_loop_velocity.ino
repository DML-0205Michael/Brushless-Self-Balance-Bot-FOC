...
void motor_output_loop(){
  ...
  // Serial.print("ele ang:"); Serial.print(ele_ang); Serial.print("\t"); // =_normalize_angle(float(DIR*PP*as5600_0.readAngle())/4096*2*M_PI)
...
float _electrical_angle(){
  ...
  // int temp1=DIR*PP*as5600_0.readAngle();
